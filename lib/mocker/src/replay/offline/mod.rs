...
pub(crate) use entrypoints::{
    ...
    simulate_agentic_trace_workload, simulate_concurrency_disagg_with_latency_models,
    simulate_concurrency_with_latency_model, simulate_concurrency_workload,
    ...
    simulate_trace_with_latency_model, simulate_trace_workload,
